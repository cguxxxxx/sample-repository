...
outputfile = './../sampleoutputs/DALWDC_AllSearchOut.csv'
...
for inputfile in os.listdir(inputfile_dir):
    ...
    out1 = df[ (df['activity_type'] == 'SessionSearch') & 
...
rawdf.groupby(['org'])[['activity_type']].count().to_csv('./../sampleoutputs/DALWDC_searchcount_byorg.csv')