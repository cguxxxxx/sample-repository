...
outputfile = './../sampleoutputs/DALWDC_AllActivityTypes.csv'
...
for inputfile in os.listdir(inputfile_dir):
    ...
    out1 = df[ (df['id'].str.find("ibm.com") == -1) &
...
rawdf.groupby(['activity_type'])[['activity_type']].count().to_csv('./../sampleoutputs/DALWDC_AllActivityTypes_byorg.csv')
